...
const file_proto_user_user_proto_rawDesc = "" +
	...
	"\fuser_service\x12:\n" +
	"\vGetUserByID\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB\x06Z\x04./pbb\x06proto3"
...
var file_proto_user_user_proto_depIdxs = []int32{
	0, // 0: user.user_service.GetUserByID:input_type -> user.GetUserRequest
	1, // 1: user.user_service.GetUserByID:output_type -> user.GetUserResponse
